...
class StatisticsReporter(BaseReporter):
    ...
    def post_evaluate(self, config, population, species, best_genome):
        ...
        self.best_fitnesses.append((best_genome.key, best_genome.fitness))
    ...
    def best_unique_genomes(self, n):
        ...
        best_unique = {}
        for key, f in self.best_fitnesses:
            best_unique[key] = f
        best_unique_list = list(best_unique.values())

        return sorted(best_unique_list, reverse=True)[:n]

    def best_genomes(self, n):
        """Returns the n most fit genomes ever seen."""

        return sorted(self.best_fitnesses, reverse=True)[:n]
    ...
    def save_genome_fitness(self,
        ...
        with open(filename, 'w') as f:
            ...
            best_fitness = [c[1] for c in self.best_fitnesses]
